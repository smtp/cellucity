		...
		<?php foreach ( $products as $product ): ?>
			<tr>
				...
				<td align="right" class="last" width="35%">
					<a style="background: #2face2 !important; height: 40px; color: #fff; line-height: 38px; padding: 18px; border: 0px solid #fff; text-decoration: none; " href="<?php echo esc_url( $product->get_permalink() ); ?>" class="automatewoo-button automatewoo-button--small"><?php esc_html_e( 'Leave a review', 'automatewoo' ); ?></a>
				</td>
