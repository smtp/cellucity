...
function ciyashop_tgmpa_plugin_list() {
	...
	$plugin_list = array(
		array(
			...
			'slug'               => 'pgs-core',
			'source'             => ciyashop_tgmpa_plugin_path( 'pgs-core-5.2.2.zip' ),
			'required'           => true,
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => ciyashop_tgmpa_plugin_path( 'revslider-6.6.8.zip' ),
			'required'           => true,
			'force_activation'   => false,
			'force_deactivation' => false,
			'version'            => '6.6.8',
		...
		array(
			...
			'slug'              => 'envato-market',
			'source'            => ciyashop_tgmpa_plugin_path( 'envato-market-2.0.7.zip' ),
			'required'          => false,
			'version'           => '2.0.7',
	...
	if ( ! $is_setup_wizard || ( $is_setup_wizard && array_key_exists( $page_builder, $page_builders ) && 'wpbakery' === $page_builder ) ) {
		$plugin_list[] = array(
			...
			'slug'               => 'js_composer',
			'source'             => ciyashop_tgmpa_plugin_path( 'js_composer-6.10.0.zip' ),
