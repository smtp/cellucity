...
function ciyashop_login_enqueue_scripts() {
	...
	wp_enqueue_style( 'ciyashop-login-css', trailingslashit( get_template_directory_uri() ) . 'css/login_style' . $suffix . '.css', array(), THEME_VERSION );
...
add_action( 'login_init', 'ciyashop_login_language_switcher_alignment_fix' );
function ciyashop_login_language_switcher_alignment_fix() {
	 ...
	 */
	$login_display_language_dropdown = apply_filters( 'login_display_language_dropdown', true );

	$languages = get_available_languages();

	if ( ! $interim_login && $login_display_language_dropdown && ! empty( $languages ) ) {
		add_action( 'login_header', 'ciyashop_login_language_switcher_alignment_fix_headder' );
		add_action( 'login_footer', 'ciyashop_login_language_switcher_alignment_fix_footer' );
	}
}

function ciyashop_login_language_switcher_alignment_fix_headder() {
	?>
	<div class="ciyashop-login-wrapper">
	<?php
}
function ciyashop_login_language_switcher_alignment_fix_footer() {
	?>
	</div>
	<?php
}
