...
require_once get_parent_theme_file_path( '/includes/woocommerce/wc-backward-compatibility.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
